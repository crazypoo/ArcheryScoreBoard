...
- (void)setupUI
{
    ...
    self.switchLabelFont = self.switchLabelFont ? self.switchLabelFont : AppFontNormal;
    ...
    self.onBackLabel.font = self.switchLabelFont;
    ...
    self.offBackLabel.font = self.switchLabelFont;
